                ...
                <div class="panel panel-default" id="newItemPanel" style="display:none;">
                    ...
                    <div class="panel-body">
                        <form action="/admininsert" method="post">
                            <h4>Airline : </h4><input name="airline" type="text" id="airline" value="${airline}" readonly class="form-control">
                            <h4>Flight No : </h4><input name="flightno" type="text" id="flightno" value="${flightno}" class="form-control">
                            <h4>From : </h4><input name="startdestination" type="text" id="startdestination" value="${startdestination}" class="form-control">
                            <h4>To : </h4><input name="enddestination" type="text" id="enddestination" value="${enddestination}" class="form-control">
                            <h4>Date of Departure : </h4><input name="departuredate" type="date" id="departuredate" value="${departuredate}" class="form-control">
                            <h4>Departure Time : </h4><input name="departuretime" type="time" id="departuretime" value="${departuretime}" placeholder="Departure Time" class="form-control">
                            <h4>Arrival Date : </h4><input name="arrivaldate" type="date" id="arrivaldate" value="${arrivaldate}" class="form-control">
                            <h4>Arrival Time : </h4><input type="time" name="arrivaltime" value="${arrivaltime}" class="form-control">
                            <h4>Seats : </h4><input name="seatleft" type="number" id="seats" value="${seatleft}" class="form-control">
                            <h4>Price : </h4><input name="price" type="text" id="price" value="${price}" class="form-control">
